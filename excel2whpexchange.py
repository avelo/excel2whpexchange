...
try:
    metadata = pd.read_excel(SPREADSHEET_FILE, 1, encoding='utf-8', engine=engine, header=None, na_filter=False).to_string(header=False, index=False)
except:
    metadata = ''
# Write file
